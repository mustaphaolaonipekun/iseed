      ...
      >
        ...
        <Card className="glass border-soft-white/20">
          <CardHeader className="text-center">
            <CardTitle className="text-2xl font-bold text-soft-white">Welcome Back</CardTitle>
            <CardDescription className="text-soft-white/70">
              Login to your ISEED 2025 account
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <p className="text-center text-sm text-soft-white/70">
                ...
                <Link to="/register" className="text-bright-aqua hover:underline font-semibold">
                  Register
                </Link>
              </p>
            </form>
